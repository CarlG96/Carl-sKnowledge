## Compile and runtime meanings

Compile time - When a pipeline processes a YAML file and gets down to the steps that require script execution, it is said to be in the compile phase.

Runtime - Whilst the YAML file is being processed. Before the step is run.

## Azure DevOps Pipelines

In Azure DevOps Pipelines, there are three different syntaxes that can be used to define variables inside a pipeline. These are:
